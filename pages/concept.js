    ...
    return (
        <Layout>
            <div className="min-h-screen h-full w-full relative overflow-hidden">
                ...
                <section id="concepthero" className="w-full h-[120vh] relative flex justify-center  bg-[url('/assets/concept/concept1.jpg')] bg-no-repeat bg-cover bg-top">
                    ...
                    <div className="absolute h-screen w-full max-w-7xl  flex flex-col  items-center  px-5 md:px-10">
                        ...
                        <div className="max-w-[750px] w-full max-h-[200px] h-full relative my-5">
                            <Image
                                src="/assets/concept/concept.png"
                                alt="concept"
                                layout="fill"
                                objectFit="contain"
                            />
                ...
                <section id="conceptcontent" className="w-full h-screen relative mt-20">
                    ...
                    <Slider {...settings} className="!w-full !h-screen bg-white xl:!hidden">
                        ...
                        <div id="part2" className="w-full h-screen overflow-hidden px-2  !flex !items-center justify-center ">
                        ...
                        <div id="part3" className="w-full h-screen overflow-hidden px-2  !flex !items-center justify-center ">
                            <div className="bg-white flex flex-col justify-center items-center  w-full h-ful">
                        ...
                        <div id="part4" className="w-full h-screen overflow-hidden">
                        ...
                        <div id="part5" className="w-full h-screen overflow-hidden px-2  !flex !items-center justify-center ">
                            <div className="bg-white flex flex-col justify-center items-center  w-full h-ful">
                                <div className="w-full p-2 border border-[#B6A694]  mb-12 max-w-xl">
                        ...
                        <div id="part6" className="w-full h-screen overflow-hidden">
                        ...
                        <div id="part8" className="w-full h-screen overflow-hidden">
                        ...
                        <div id="part9" className="w-full h-screen overflow-hidden px-2  !flex !items-center justify-center ">
                            <div className="bg-white flex flex-col justify-center items-center  w-full h-ful">
                                <div className="w-full p-2 border border-[#B6A694]  mb-12 max-w-xl">
                        ...
                        <div id="part10" className="w-full h-screen overflow-hidden">
                            <div className="bg-[url('/assets/concept/concept10.jpg')]  bg-no-repeat bg-center bg-cover flex flex-col justify-end items-center  relative w-full h-full pb-20">
                            </div>
                        </div>

                        <div id="part11" className="w-full h-screen overflow-hidden">
                            <div className="bg-[url('/assets/concept/concept10.jpg')]  bg-no-repeat bg-right bg-cover flex flex-col justify-center items-center  relative w-full h-full pb-20">
                        ...
                        <div id="part12" className="w-full h-screen overflow-hidden px-2  !flex !items-center justify-center ">
