...
const Index = () => {
    ...
    return (
        <Layout>
            <div className="min-h-screen h-full w-full flex justify-center px-5 md:px-10 ">
                <div className="max-w-5xl w-full h-full flex justify-center items-center mt-28">
                    <div>
